...
import testimonials from '../Hooks/testimonialData';
const Testimonial = () => {
    ...
    const settings = {
        ...
        rows: 3, // Use only one row for the grid
    ...
    return (
        <>
            ...
            <div className="relative overflow-hidden flex flex-col h-[100vh]   items-center justify-start w-full p-4 pt-10 pb-10 bg-[#fefefe]">
                ...
                <div className="absolute bottom-0 left-0 right-0 h-[10rem] z-[2] pointer-events-none bg-gradient-to-t from-white via-[#ffffffa8] to-transparent"></div>
            </div>
        </>
    );
};
