    ...
    return (
        <div className='flex bg-[#F5F6F7] flex-col px-[5vw] gap-8 md:flex-row md:justify-around items-center justify-center py-28 lg:pb-40'>
            <div className='max-w-[28rem] relative sm:mb-36 md:mb-0 sm:mr-16 md:mr-0 lg:mr-20'>
                ...
                <img src={shape1} alt="" className='w-[28%] hidden md:hidden lg:block sm:block  absolute top-[85px] right-[-80px]' />
                <img src={shape2} alt="" className='w-[26%] hidden md:hidden lg:block sm:block absolute bottom-[-92px] left-[140px]' />
            </div>
