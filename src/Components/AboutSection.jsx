    ...
    return (
        <div className='flex bg-[#F5F6F7] flex-col px-[5vw] gap-8 lg:flex-row lg:justify-around items-center justify-center py-28 lg:pb-40'>
            ...
            <div className='max-w-[33rem] md:max-w-[30rem] md:mt-2'>
                <h1 className='sora-600 leading-[3rem] mb-4 text-[2.5rem] text-[#0A165D]' data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="1000">Innovative Solutions for Your IT Needs.</h1>
                <p className='sora-400 leading-[1.85rem] text-[#535760]' data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="1200">We offer a full range of IT services, from web development and graphic design to digital marketing, delivering innovative, customized solutions that drive business growth and help you achieve your goals effectively.</p>
                <div className='flex my-12' ref={counterRef} data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="1200">
                    <div className='w-[50%]'>
                ...
                {btn &&
                    <Link to={'/about'}
                        className="relative flex items-center px-8 py-4 overflow-hidden w-fit font-medium transition-all bg-[#2B4DFF] rounded-md group" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="1600"
                    >
